        ...
        class o {
          ...
          trigger(t, e) {
            ...
            try {
              ...
              if (
                (n.initEvent(`${this.eventPrefix}${t}`, !0, !0),
                (n.data = e),
          ...
          method(t, e) {
            return "ready" === t && "function" == typeof e
              ? (this.on("ready", e), !0)
              : (this[t] && this[t](e), !0);
          }
  ...
  (n.d = function (t, e) {
    ...
    (function () {
      const t = Date.now(),
        ...
        o = e
          ? "https://widget-v4.tidiochat.com//dist/"
      ...
      function d(t) {
        ...
        })(t, `${o.replace(/\/$/, "")}/1_195_0/static/js/widget.${n.h()}.js`);
      }
      const a = n(2655).Z;
          ...
          setTimeout(() => {
            ...
            !(function (t, e, n) {
              ...
              e &&
                ...
                (function (t) {
                  let e =
                    "https://widget-v4.tidiochat.com/static/js/WidgetIframe.js";
                  e = `${o}1_195_0/static/js/chunk-WidgetIframe-${n.h()}.js`;
